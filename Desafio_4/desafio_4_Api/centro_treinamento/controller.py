...
from desafio_4_Api.centro_treinamento.schemas import CentroTreinamentoIn, CentroTreinamentoOut
from desafio_4_Api.centro_treinamento.models import CentroTreinamentoModel

from desafio_4_Api.contrib.dependencies import DatabaseDependency
